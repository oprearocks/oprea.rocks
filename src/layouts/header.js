        ...
        <nav className="header-nav">
          ...
          <ul className={this.state.isNavVisible ? '' : 'header-nav--hidden'}>
            <li>
              ...
              <Icon size="large" name="newspaper outline" />Articles
              </Link>
            </li>
            <li>
            ...
            <li>
              ...
              <Icon size="large" name="book" />Reading List
              </Link>
            </li>
            <li>
              <Link className="nav-link" activeClassName="active" to="/hire">
              <Icon size="large" name="user" />About
              </Link>
            </li>
            <li>
              ...
              >
                <Icon size="large" name="facebook messenger" />Contact me!
              </a>
            </li>
          </ul>
        </nav>
